...
function SimpleApp() {
  return (
    <div style={{ padding: '20px', textAlign: 'center', minHeight: '100vh', backgroundColor: '#f0f0f0' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto', paddingTop: '50px' }}>
        <h1 style={{ color: '#333', marginBottom: '20px' }}>Campus Bus Assistant</h1>
        ...
        <div style={{ 
          ...
          <div style={{ color: '#16a34a', fontSize: '16px' }}>
            ...
            ✅ Build system operational<br/>
            ✅ No createContext errors<br/>
